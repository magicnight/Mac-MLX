...
export const facts = Object.freeze([
  ...
  fact("kv-cache-quantization", "released", "0.6.0", ["architecture", "choosing-a-model"], [release, changelog, tagged("MacMLXCore/Sources/MacMLXCore/Engine/GenerateRequest.swift"), tagged("MacMLXCore/Sources/MacMLXCore/Engine/MLXSwiftEngine.swift")],
